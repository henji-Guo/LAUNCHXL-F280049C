...
PAGE 0 :
   ...
   FLASH_BANK0_CODE  : origin = 0x083000, length = 0x00CFF0	/* on-chip Flash */
   ...
   /* BANK 1 */
   FLASH_BANK1_SEC0  : origin = 0x090000, length = 0x00FFF0	/* on-chip Flash */
...
SECTIONS
{
   ...
   .text            : > FLASH_BANK0_CODE,     PAGE = 0, ALIGN(4)
