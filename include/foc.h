...
/* USER_DEFINED */
#define FOC_MOTOR_Poles     7U
#define FOC_MOTOR_Rs        7.5f
#define FOC_MOTOR_Ld        0.0f
#define FOC_MOTOR_Lq        0.0f
#define FOC_MOTOR_Flux      0.0f

#define FOC_Id_Kp           0.0f
#define FOC_Id_Ki           0.0f
#define FOC_Iq_Kp           0.0f
#define FOC_Iq_Ki           0.0f
#define FOC_Speed_Kp        0.0f
#define FOC_Speed_Ki        0.0f
